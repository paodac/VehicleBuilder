    ...
    inquirer
      ...
      .then((answers) => {
        ...
        if (selectedVehicle.vin=== truck.vin) {
          ...
          this.performActions();
        } else{truck.tow(selectedVehicle);
          this.performActions();
        }
      ...
      .then((answers) => {
        ...
        if (answers.action === 'Print details') {
          ...
          if (truck instanceof Truck) {
              this.findVehicleToTow(truck);  // Pasamos la instancia de truck
              return; // Return to avoid instantly calling performActions again
          } else {
              console.log("This vehicle is not a truck and cannot tow.");
          }
        // TODO: add statements to perform the tow action only if the selected vehicle is a truck. Call the findVehicleToTow method to find a vehicle to tow and pass the selected truck as an argument. After calling the findVehicleToTow method, you will need to return to avoid instantly calling the performActions method again since findVehicleToTow is asynchronous.
          ...
          const motorbike = this.vehicles.find(vehicle => vehicle.vin === this.selectedVehicleVin && vehicle instanceof Motorbike);
          if (motorbike instanceof Motorbike) {
              motorbike.wheelie(); // Esto debería funcionar correctamente
          } else {
              console.log("This vehicle is not a motorbike and cannot do a wheelie.");
          }
